      ...
      <div className='flex flex-col sm:flex-row md:flex-row gap-4 md:gap-2 px-4 md:px-15 py-10 '>
        ...
        <div className='flex order-3 sm:order-3 lg:order-3 md:order-3 flex-col gap-5 px-4 md:px-5 text-center md:text-left'>
          ...
          <div className='flex gap-3 justify-center md:justify-start flex-wrap'>
            <button className='border active:bg-green-500 focus:bg-green-500 border-gray-200 hover:scale-105 transition-all hover:bg-green-500 outline-0 cursor-pointer px-3 md:px-5 rounded py-2 text-sm md:text-base'>S</button>
            <button className='border active:bg-green-500 focus:bg-green-500 hover:scale-105 transition-all hover:bg-green-500 border-gray-200 outline-0 cursor-pointer px-3 md:px-5 rounded py-2 text-sm md:text-base'>M</button>
            <button className='border active:bg-green-500 focus:bg-green-500 hover:scale-105 transition-all hover:bg-green-500 border-gray-200 outline-0 cursor-pointer px-3 md:px-5 rounded py-2 text-sm md:text-base'>L</button>
            <button className='border active:bg-green-500 focus:bg-green-500 hover:scale-105 transition-all hover:bg-green-500 border-gray-200 outline-0 cursor-pointer px-3 md:px-5 rounded py-2 text-sm md:text-base'>XL</button>
            <button className='border active:bg-green-500 focus:bg-green-500 hover:scale-105 transition-all hover:bg-green-500 border-gray-200 outline-0 cursor-pointer px-3 md:px-5 rounded py-2 text-sm md:text-base'>XXL</button>
          </div>
