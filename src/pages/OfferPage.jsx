...
const OfferPage = () => {
  return (
    <div className='flex justify-center px-20  py-10 '>
        <div className='bg-linear-to-t from-emerald-400 to-white items-center w-full justify-center md:justify-evenly rounded-2xl flex flex-col md:flex-row py-10 px-4 md:px-30'>
