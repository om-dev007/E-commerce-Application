...
const Footer = () => {
    return (
        <>
            <div className='flex justify-self-center gap-5 flex-col  px-10'>
                <div className='flex py-5 justify-center gap-5 items-center'>
                    <div>
                        <img className='w-10' src={logo} alt="" />
                    </div>
                    <div>
                        <h3 className='text-4xl text-[#454545] font-bold '>Shopify</h3>
                    </div>
                </div>
                <div className='flex gap-5 text-gray-700 font-medium text-lg '>
